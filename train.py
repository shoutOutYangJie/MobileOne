...
IMAGENET_TRAINSET_SIZE = 1281167 # imagenet 1000k
...
def train(train_loader, model, criterion, optimizer, epoch, args, lr_scheduler, is_main):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # todo: add custwd.
        if args.custwd:  # do not activate
...
# python train.py -a mobileone_s0 --dist-url 'tcp://127.0.0.1:23333' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1  --rank 0 --workers 32 /dataset/ILSVRC/Data/CLS-LOC --tag hello  --wd 4e-5
